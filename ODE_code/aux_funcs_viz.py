...
def plot_herd_snapshot(temp_H, curr_time, temp_counterr, loc_arrays, traj_array = [0,0,0]):
  ...
  Note that in this code, a refers to a-prime (the angle referred to in the text equations, but not "a" in the equations. "a" in the equations is different from a in the code by a factor 
  of R)
  '''
